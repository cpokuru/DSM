...
#ifdef USE_RDK_BUNDLE_MANAGER
   // New path: treat URI as OCI image URL, use rdkBundleManager to create OCI bundle locally
   {
      std::string platform = bundleManagerConfig_.value("platform", "");
      std::string searchPath = bundleManagerConfig_.value("searchPath", "");
      ...
      OciBundleGenerator bundleGen(platform, searchPath, bundleOutputBaseDir);
